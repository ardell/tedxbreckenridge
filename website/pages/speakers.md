...
<div style="margin: 48px 0 60px;">
  <img src="{{ '/assets/images/events/speaker-on-red-dot-with-string-lights.jpg' | relative_url }}" alt="TEDxBreckenridge speaker presenting on the iconic red dot with beautiful venue lighting" style="width: 100%; height: auto; border-radius: 8px;" loading="lazy">
</div>
...
<div style="margin: 48px 0 60px;">
  <img src="{{ '/assets/images/events/speakers-posing-outside.jpg' | relative_url }}" alt="TEDxBreckenridge speakers posing together outdoors, representing our community of local voices" style="width: 100%; height: auto; border-radius: 8px;" loading="lazy">
</div>
...
<div style="margin: 48px 0 60px;">
  <img src="{{ '/assets/images/events/speaker-raising-hand.jpg' | relative_url }}" alt="TEDxBreckenridge speaker engaging dynamically with the audience during their talk" style="width: 100%; height: auto; border-radius: 8px;" loading="lazy">
</div>
